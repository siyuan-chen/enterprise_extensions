...
def model_singlepsr_noise(psr, tm_var=False, tm_linear=False,
    ...
    :param dm_expdip_sign: set the sign parameter for dip
    ...
    if dm_var:
        ...
        if dm_expdip:
            ...
            dm_expdip_sign = (dm_expdip_sign if isinstance(dm_expdip_sign,list)
                                             else [dm_expdip_sign]*int(num_dips))
        ...
        if dm_cusp:
            ...
            dm_cusp_sign = (dm_cusp_sign if isinstance(dm_cusp_sign, list)
                                         else [dm_cusp_sign]*int(num_dm_cusps))
...
def model_2a(psrs, psd='powerlaw', noisedict=None, components=30,
             ...
             select='backend', pshift=False, pseed=None,
             psr_models=False, tm_marg=False, dense_like=False):
    """
    Reads in list of enterprise Pulsar instance and returns a PTA
