...
def model_bwm(psrs, likelihood=LogLikelihood, lookupdir=None, noisedict=None, tm_svd=False,
    ...
    s += deterministic.bwm_block(Tmin_bwm, Tmax_bwm, logmin=burst_logmin, logmax=burst_logmax,
                                 amp_prior=amp_prior, skyloc=skyloc, name='bwm')
...
def model_bwm_sglpsr(psr, likelihood=LogLikelihood, lookupdir=None,
    ...
    # GW BWM signal block
    s += deterministic.bwm_sglpsr_block(Tmin_bwm, Tmax_bwm, logmin=burst_logmin, logmax=burst_logmax,
                                        amp_prior=amp_prior, fixed_sign=fixed_sign, name='ramp')
